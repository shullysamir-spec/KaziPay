...
export const SUPER_ADMIN_CREDENTIALS = {
  email: 'admin@kazipay.cd',
  password: 'Admin@2026!',
  displayName: 'Super Administrateur KaziPay',
};

export const TEST_ACCOUNTS = [
  { roleName: 'Super Administrateur', email: 'admin@kazipay.cd', password: 'Admin@2026!', roleCode: RoleCode.SUPERADMIN, color: 'bg-purple-600' },
  { roleName: 'Gestionnaire RH', email: 'rh@kazipay.cd', password: 'Rh@2026!', roleCode: RoleCode.HR_MANAGER, color: 'bg-blue-600' },
  { roleName: 'Gestionnaire Paie', email: 'paie@kazipay.cd', password: 'Paie@2026!', roleCode: RoleCode.PAYROLL_MANAGER, color: 'bg-emerald-600' },
  { roleName: 'Manager / Chef de Service', email: 'manager@kazipay.cd', password: 'Manager@2026!', roleCode: RoleCode.DEPT_MANAGER, color: 'bg-amber-600' },
  { roleName: 'Directeur Financier', email: 'finance@kazipay.cd', password: 'Finance@2026!', roleCode: RoleCode.FINANCE_MANAGER, color: 'bg-indigo-600' },
  { roleName: 'Employé Self-Service', email: 'employe@kazipay.cd', password: 'Employe@2026!', roleCode: RoleCode.EMPLOYEE, color: 'bg-slate-600' },
  { roleName: 'Auditeur Externe', email: 'auditeur@kazipay.cd', password: 'Auditeur@2026!', roleCode: RoleCode.AUDITOR, color: 'bg-rose-600' },
];
  ...
  const demoAuditLogs = [
    {
      ...
      action: 'BOOTSTRAP',
      module: 'SYSTEME',
      description: 'Initialisation globale du système KaziPay ERP RDC 2026',
